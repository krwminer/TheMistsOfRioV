...
public class ContainerDarkener extends Container
{
	private TileEntityDarkener infuser;
	private int lastCookTime = 0;
	private int lastBurnTime = 0;
	private int lastItemBurnTime = 0;

	public ContainerDarkener(InventoryPlayer par1InventoryPlayer, TileEntityDarkener tile_entity)
	{
		this.infuser = tile_entity;

		this.addSlotToContainer(new Slot(tile_entity, 0, 100, 20));
		this.addSlotToContainer(new Slot(tile_entity, 1, 60, 20));
		this.addSlotToContainer(new Slot(tile_entity, 2, 80, 55));
	 ...
	 public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
	{
		...
		if (var4 != null && var4.getHasStack())
		{
			...
			{
				if (DarkenerRecipes.recipe().getResult(var5) != null)
				{
				...
				else if (TileEntityDarkener.isItemFuel(var5))
				{
