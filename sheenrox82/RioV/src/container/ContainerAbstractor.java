...
import sheenrox82.RioV.src.slot.SlotAbstractor;
import sheenrox82.RioV.src.tileentity.TileEntityAbstractor;

public class ContainerAbstractor extends Container
{
    private TileEntityAbstractor blast;
    private int dualCookTime;
    private int dualBurnTime;
    private int lastItemBurnTime;

    public ContainerAbstractor(InventoryPlayer inventoryplayer, TileEntityAbstractor tileentityInputFurnace)
    {
        dualCookTime = 0;
        dualBurnTime = 0;
        lastItemBurnTime = 0;
        ...
        this.addSlotToContainer(new SlotAbstractor(inventoryplayer.player, tileentityInputFurnace, 3, 116, 35));
