...
public class BlockWhiteFire extends BlockFire
{
	...
	public BlockWhiteFire(int par1)
	{
		super(par1);
	...
	public void onBlockAdded(World par1World, int par2, int par3, int par4)
	{
		...
		if ((par1World.getBlockId(par2, par3 - 1, par4) != Blocks.blindoniteBlock.blockID) || (!Blocks.vaerynPortal.tryToCreatePortal(par1World, par2, par3, par4)))
		{
			if ((!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4)) && (!canNeighborBurn(par1World, par2, par3, par4)))
			{
				par1World.setBlockToAir(par2, par3, par4);
	...
	public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
	{
		...
		if ((!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4)) && (!Blocks.whiteFire.canBlockCatchFire(par1World, par2, par3 - 1, par4, ForgeDirection.UP)))
		{
			if (Blocks.whiteFire.canBlockCatchFire(par1World, par2 - 1, par3, par4, ForgeDirection.EAST))
			{
				for (int l = 0; l < 2; l++)
				{
			...
			if (Blocks.whiteFire.canBlockCatchFire(par1World, par2 + 1, par3, par4, ForgeDirection.WEST))
			{
				for (int l = 0; l < 2; l++)
				{
			...
			if (Blocks.whiteFire.canBlockCatchFire(par1World, par2, par3, par4 - 1, ForgeDirection.SOUTH))
			{
				for (int l = 0; l < 2; l++)
				{
			...
			if (Blocks.whiteFire.canBlockCatchFire(par1World, par2, par3, par4 + 1, ForgeDirection.NORTH))
			{
				for (int l = 0; l < 2; l++)
				{
					float f = par2 + par5Random.nextFloat();
			...
			if (Blocks.whiteFire.canBlockCatchFire(par1World, par2, par3 + 1, par4, ForgeDirection.DOWN))
			{
				for (int l = 0; l < 2; l++)
				{
					float f = par2 + par5Random.nextFloat();
