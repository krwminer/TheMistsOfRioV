...
public class BlockBlackFire extends BlockFire
{
	...
	public BlockBlackFire(int par1)
	{
		super(par1);
	...
	public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
	{
		...
		if ((!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4)) && (!Blocks.blackFire.canBlockCatchFire(par1World, par2, par3 - 1, par4, ForgeDirection.UP)))
		{
			if (Blocks.blackFire.canBlockCatchFire(par1World, par2 - 1, par3, par4, ForgeDirection.EAST))
			{
				for (int l = 0; l < 2; l++)
				{
			...
			if (Blocks.blackFire.canBlockCatchFire(par1World, par2 + 1, par3, par4, ForgeDirection.WEST))
			{
				for (int l = 0; l < 2; l++)
				{
			...
			if (Blocks.blackFire.canBlockCatchFire(par1World, par2, par3, par4 - 1, ForgeDirection.SOUTH))
			{
				for (int l = 0; l < 2; l++)
				{
			...
			if (Blocks.blackFire.canBlockCatchFire(par1World, par2, par3, par4 + 1, ForgeDirection.NORTH))
			{
				for (int l = 0; l < 2; l++)
				{
					float f = par2 + par5Random.nextFloat();
			...
			if (Blocks.blackFire.canBlockCatchFire(par1World, par2, par3 + 1, par4, ForgeDirection.DOWN))
			{
				for (int l = 0; l < 2; l++)
				{
					float f = par2 + par5Random.nextFloat();
	...
	{
		this.iconArray = new Icon[] { par1IconRegister.registerIcon(Util.MOD_ID + ":" + "blackFire_layer_0"), par1IconRegister.registerIcon(Util.MOD_ID + ":" + "blackFire_layer_1")};
	}
