...
public class BlockDarkeningAltar extends BlockContainer
{
	...
	public BlockDarkeningAltar(int par1, boolean par3)
	{
	...
	{
		this.blockIcon = par1IconRegister.registerIcon(Util.MOD_ID + ":" + "darkener_side");
		this.field_94461_a = par1IconRegister.registerIcon(Util.MOD_ID + ":" + "darkener_top");
		this.field_94460_b = par1IconRegister.registerIcon(Util.MOD_ID + ":" + "darkener_bottom");
	}
		...
		for (int var6 = par2 - 2; var6 <= par2 + 2; ++var6)
		{
			for (int var7 = par4 - 2; var7 <= par4 + 2; ++var7)
			{
				...
				if (par5Random.nextInt(16) == 0)
				{
					...
					{
						par1World.spawnParticle("largesmoke", (double)par2 + 0.5D, (double)par3 + 1.0D, (double)par4 + 0.5D, (double)((float)(var6 - par2) + par5Random.nextFloat()) - 0.5D, (double)((float)(var8 - par3) - par5Random.nextFloat() - 0.0F), (double)((float)(var7 - par4) + par5Random.nextFloat()) - 0.5D);
						par1World.spawnParticle("portal", (double)par2 + 0.5D, (double)par3 + 1.0D, (double)par4 + 0.5D, (double)((float)(var6 - par2) + par5Random.nextFloat()) - 0.5D, (double)((float)(var8 - par3) - par5Random.nextFloat() - 0.0F), (double)((float)(var7 - par4) + par5Random.nextFloat()) - 0.5D);
					}
				}
			}
		}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9) {
		...
		if (!world.isRemote)
		{
			TileEntityDarkener tileEntityInfusionAltar = (TileEntityDarkener) world.getBlockTileEntity(x, y, z);
	...
	public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
	{
		...
		{
			TileEntityDarkener var7 = (TileEntityDarkener)par1World.getBlockTileEntity(par2, par3, par4);
