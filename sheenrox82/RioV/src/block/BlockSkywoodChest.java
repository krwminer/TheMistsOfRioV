...
public class BlockSkywoodChest extends BlockChest
{
    ...
    public BlockSkywoodChest(int par1, int par2)
    {
        super(par1, par2);
        this.isTrapped = par2;
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLiving par5EntityLiving, ItemStack par6ItemStack)
    {
        ...
        {
            ((TileEntitySkywoodChest)par1World.getBlockTileEntity(par2, par3, par4)).setChestGuiName(par6ItemStack.getDisplayName());
        }
    }
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        TileEntitySkywoodChest tileentitychest = (TileEntitySkywoodChest)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    {
        Object object = (TileEntitySkywoodChest)par1World.getBlockTileEntity(par2, par3, par4);
        ...
        else
        {
            if (par1World.getBlockId(par2 - 1, par3, par4) == this.blockID)
            {
                object = new InventoryLargeChest("container.chestDouble", (TileEntitySkywoodChest)par1World.getBlockTileEntity(par2 - 1, par3, par4), (IInventory)object);
            }

            if (par1World.getBlockId(par2 + 1, par3, par4) == this.blockID)
            {
                object = new InventoryLargeChest("container.chestDouble", (IInventory)object, (TileEntitySkywoodChest)par1World.getBlockTileEntity(par2 + 1, par3, par4));
            }

            if (par1World.getBlockId(par2, par3, par4 - 1) == this.blockID)
            {
                object = new InventoryLargeChest("container.chestDouble", (TileEntitySkywoodChest)par1World.getBlockTileEntity(par2, par3, par4 - 1), (IInventory)object);
            }

            if (par1World.getBlockId(par2, par3, par4 + 1) == this.blockID)
            {
                object = new InventoryLargeChest("container.chestDouble", (IInventory)object, (TileEntitySkywoodChest)par1World.getBlockTileEntity(par2, par3, par4 + 1));
            }
    ...
    {
    	TileEntitySkywoodChest tileentitychest = new TileEntitySkywoodChest();
    ...
    public int isProvidingWeakPower(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
        ...
        {
            int i1 = ((TileEntitySkywoodChest)par1IBlockAccess.getBlockTileEntity(par2, par3, par4)).numUsingPlayers;
