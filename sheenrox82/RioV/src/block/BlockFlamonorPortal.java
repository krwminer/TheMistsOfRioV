...
public class BlockFlamonorPortal extends BlockBreakable
{
	public BlockFlamonorPortal(int par1)
	{
		super(par1, Util.MOD_ID + ":" + "flamonorPortal", Material.portal, false);
	...
	public boolean tryToCreatePortal(World par1World, int par2, int par3, int par4)
	{
		byte b0 = 0;
		byte b1 = 0;
		if (par1World.getBlockId(par2 - 1, par3, par4) == Blocks.jaavikBlock.blockID || par1World.getBlockId(par2 + 1, par3, par4) == Blocks.jaavikBlock.blockID)
		{
			b0 = 1;
		}
		if (par1World.getBlockId(par2, par3, par4 - 1) == Blocks.jaavikBlock.blockID || par1World.getBlockId(par2, par3, par4 + 1) == Blocks.jaavikBlock.blockID)
		{
			b1 = 1;
		}
		if (b0 == b1)
		...
		else
		{
			...
			for (l = -1; l <= 2; ++l)
			{
				for (i1 = -1; i1 <= 3; ++i1)
				{
					...
					if (l != -1 && l != 2 || i1 != -1 && i1 != 3)
					{
						...
						if (flag)
						{
							if (j1 != Blocks.jaavikBlock.blockID)
							{
								return false;
							}
						}
						else if (j1 != 0 && j1 != Blocks.redFire.blockID)
						{
							return false;
						}
					}
			...
			for (l = 0; l < 2; ++l)
			{
				for (i1 = 0; i1 < 3; ++i1)
				{
					par1World.setBlock(par2 + b0 * l, par3 + i1, par4 + b1 * l, Blocks.flamonorPortal.blockID, 0, 2);
				}
			}
			return true;
		}
	...
	public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
	{
		...
		if (par1World.getBlockId(par2, i1 - 1, par4) != Blocks.jaavikBlock.blockID)
		{
		...
		else
		{
			...
			if (j1 == 3 && par1World.getBlockId(par2, i1 + j1, par4) == Blocks.jaavikBlock.blockID)
			{
				...
				{
					if ((par1World.getBlockId(par2 + b0, par3, par4 + b1) != Blocks.jaavikBlock.blockID || par1World.getBlockId(par2 - b0, par3, par4 - b1) != this.blockID) && (par1World.getBlockId(par2 - b0, par3, par4 - b1) != Blocks.jaavikBlock.blockID || par1World.getBlockId(par2 + b0, par3, par4 + b1) != this.blockID))
					{
						par1World.setBlockToAir(par2, par3, par4);
					}
				}
