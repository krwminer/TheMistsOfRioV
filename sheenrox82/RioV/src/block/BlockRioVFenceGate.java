...
public class BlockRioVFenceGate extends BlockFenceGate
{
	...
	{
		if(blockID == Blocks.glimmerwoodFenceGate.blockID) blockIcon = par1IconRegister.registerIcon(Util.MOD_ID + ":" + "glimmerwoodPlanks");
		if(blockID == Blocks.cherryBlossomFenceGate.blockID) blockIcon = par1IconRegister.registerIcon(Util.MOD_ID + ":" + "cherryPlanks");
		if(blockID == Blocks.bloodFenceGate.blockID) blockIcon = par1IconRegister.registerIcon(Util.MOD_ID + ":" + "bloodPlanks");
		if(blockID == Blocks.skywoodFenceGate.blockID) blockIcon = par1IconRegister.registerIcon(Util.MOD_ID + ":" + "skywoodPlanks");
	}
}
