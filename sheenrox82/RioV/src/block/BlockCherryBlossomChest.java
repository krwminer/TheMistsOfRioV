...
public class BlockCherryBlossomChest extends BlockChest
{
    private final Random random = new Random();
    public final int isTrapped;
    
    public BlockCherryBlossomChest(int par1, int par2)
    {
        super(par1, par2);
        this.isTrapped = par2;
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLiving, ItemStack par6ItemStack)
    {
        ...
        {
            ((TileEntityCherryBlossomChest)par1World.getBlockTileEntity(par2, par3, par4)).setChestGuiName(par6ItemStack.getDisplayName());
        }
    }
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        TileEntityCherryBlossomChest tileentitychest = (TileEntityCherryBlossomChest)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    {
        Object object = (TileEntityCherryBlossomChest)par1World.getBlockTileEntity(par2, par3, par4);
        ...
        else
        {
            if (par1World.getBlockId(par2 - 1, par3, par4) == this.blockID)
            {
                object = new InventoryLargeChest("container.chestDouble", (TileEntityCherryBlossomChest)par1World.getBlockTileEntity(par2 - 1, par3, par4), (IInventory)object);
            }

            if (par1World.getBlockId(par2 + 1, par3, par4) == this.blockID)
            {
                object = new InventoryLargeChest("container.chestDouble", (IInventory)object, (TileEntityCherryBlossomChest)par1World.getBlockTileEntity(par2 + 1, par3, par4));
            }

            if (par1World.getBlockId(par2, par3, par4 - 1) == this.blockID)
            {
                object = new InventoryLargeChest("container.chestDouble", (TileEntityCherryBlossomChest)par1World.getBlockTileEntity(par2, par3, par4 - 1), (IInventory)object);
            }

            if (par1World.getBlockId(par2, par3, par4 + 1) == this.blockID)
            {
                object = new InventoryLargeChest("container.chestDouble", (IInventory)object, (TileEntityCherryBlossomChest)par1World.getBlockTileEntity(par2, par3, par4 + 1));
            }
    ...
    public int isProvidingWeakPower(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
        ...
        {
            int i1 = ((TileEntityCherryBlossomChest)par1IBlockAccess.getBlockTileEntity(par2, par3, par4)).numUsingPlayers;
