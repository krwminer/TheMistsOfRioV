...
public class BlockRioVTrapDoor extends Block
{
    /** Set this to allow trapdoors to remain free-floating */
    public static boolean disableValidation = false;

    public BlockRioVTrapDoor(int par1, Material par2Material)
    {
	...
	{
		if(blockID == Blocks.glimmerwoodTrapdoor.blockID) this.blockIcon = iconRegister.registerIcon(Util.MOD_ID + ":" + "glimmerwoodTrapDoor");
		if(blockID == Blocks.cherryBlossomTrapdoor.blockID) this.blockIcon = iconRegister.registerIcon(Util.MOD_ID + ":" + "cherryBlossomTrapDoor");
		if(blockID == Blocks.bloodTrapdoor.blockID) this.blockIcon = iconRegister.registerIcon(Util.MOD_ID + ":" + "bloodTrapDoor");
		if(blockID == Blocks.skywoodTrapdoor.blockID) this.blockIcon = iconRegister.registerIcon(Util.MOD_ID + ":" + "skywoodTrapDoor");
	}
}
