...
{
	public BlockRioVLadder(int par1)
	{
		super(par1);
	...
	{
		if(blockID == Blocks.glimmerwoodLadder.blockID) this.blockIcon = iconRegister.registerIcon(Util.MOD_ID + ":" + "glimmerwoodLadder");
		if(blockID == Blocks.cherryBlossomLadder.blockID) this.blockIcon = iconRegister.registerIcon(Util.MOD_ID + ":" + "cherryBlossomLadder");
		if(blockID == Blocks.bloodLadder.blockID) this.blockIcon = iconRegister.registerIcon(Util.MOD_ID + ":" + "bloodLadder");
		if(blockID == Blocks.skywoodLadder.blockID) this.blockIcon = iconRegister.registerIcon(Util.MOD_ID + ":" + "skywoodLadder");
	}
