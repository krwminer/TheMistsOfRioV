...
public class WorldGenSanctuatiteTree extends WorldGenerator
{
    public WorldGenSanctuatiteTree(boolean par1)
    {
        super(par1);
    }
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (par4 >= 1 && par4 + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isValidSoil = soil != null && soil.canSustainPlant(par1World, par3, par4 - 1, par5, ForgeDirection.UP, (BlockRioVSapling)Blocks.skywoodSapling);
                ...
                if (isValidSoil && par4 < 256 - l - 1)
                {
                    ...
                    for (j2 = 0; j2 <= j1; ++j2)
                    {
                        ...
                        for (i3 = par3 - k2; i3 <= par3 + k2; ++i3)
                        {
                            ...
                            for (int l3 = par5 - k2; l3 <= par5 + k2; ++l3)
                            {
                                ...
                                {
                                    this.setBlockAndMetadata(par1World, i3, j3, l3, Blocks.skycloud.blockID, 1);
                                }
                            }
                        }
                    ...
                    for (j3 = 0; j3 < l - j2; ++j3)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + j3, par5, Blocks.skywoodLog.blockID, 2);
                        }
                    }
