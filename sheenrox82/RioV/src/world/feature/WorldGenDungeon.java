...
public class WorldGenDungeon extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) 
	{
		...
		world.setBlock(i + 0, j + 1, k + 6, Blocks.slateBricks.blockID);
		...
		world.setBlock(i + 0, j + 4, k + 1, Blocks.slateBricks.blockID);
		...
		world.setBlock(i + 0, j + 4, k + 7, Blocks.slateBricks.blockID);
		world.setBlock(i + 1, j + 0, k + 1, Blocks.slateBricks.blockID);
		world.setBlock(i + 1, j + 0, k + 2, Blocks.slateBricks.blockID);
		world.setBlock(i + 1, j + 0, k + 3, Blocks.slateBricks.blockID);
		...
		world.setBlock(i + 1, j + 5, k + 1, Blocks.slateBricks.blockID);
		...
		world.setBlock(i + 1, j + 9, k + 6, Blocks.slateBricks.blockID);
		...
		world.setBlock(i + 2, j + 0, k + 4, Blocks.slateBricks.blockID);
		world.setBlock(i + 2, j + 0, k + 5, Blocks.slateBricks.blockID);
		...
		world.setBlock(i + 2, j + 4, k + 6, Blocks.slateBricks.blockID);
		...
		world.setBlock(i + 2, j + 6, k + 4, Blocks.slateBricks.blockID);
		...
		world.setBlock(i + 3, j + 0, k + 2, Blocks.slateBricks.blockID);
		...
		world.setBlock(i + 3, j + 4, k + 5, Blocks.slateBricks.blockID);
		world.setBlock(i + 3, j + 4, k + 6, Blocks.slateBricks.blockID);
		world.setBlock(i + 3, j + 5, k + 2, Blocks.slateBricks.blockID);
		world.setBlock(i + 3, j + 5, k + 5, Blocks.slateBricks.blockID);
		world.setBlock(i + 3, j + 6, k + 2, Blocks.slateBricks.blockID);
		...
		world.setBlock(i + 4, j + 0, k + 4, Blocks.slateBricks.blockID);
		...
		world.setBlock(i + 4, j + 4, k + 6, Blocks.slateBricks.blockID);
		world.setBlock(i + 4, j + 5, k + 2, Blocks.slateBricks.blockID);
		world.setBlock(i + 4, j + 5, k + 5, Blocks.slateBricks.blockID);
		world.setBlock(i + 4, j + 6, k + 2, Blocks.slateBricks.blockID);
		...
		world.setBlock(i + 4, j + 7, k + 5, Blocks.slateBricks.blockID);
		...
		world.setBlock(i + 5, j + 4, k + 4, Blocks.slateBricks.blockID);
		...
		world.setBlock(i + 5, j + 5, k + 2, Blocks.slateBricks.blockID);
		...
		world.setBlock(i + 5, j + 7, k + 2, Blocks.slateBricks.blockID);
		...
		world.setBlock(i + 6, j + 0, k + 3, Blocks.slateBricks.blockID);
		...
		world.setBlock(i + 6, j + 4, k + 2, Blocks.slateBricks.blockID);
		world.setBlock(i + 6, j + 4, k + 3, Blocks.slateBricks.blockID);
		world.setBlock(i + 6, j + 4, k + 4, Blocks.slateBricks.blockID);
		...
		world.setBlock(i + 6, j + 5, k + 6, Blocks.slateBricks.blockID);
		world.setBlock(i + 6, j + 7, k + 1, Blocks.slateBricks.blockID);
		world.setBlock(i + 6, j + 7, k + 2, Blocks.slateBricks.blockID);
		world.setBlock(i + 6, j + 7, k + 3, Blocks.slateBricks.blockID);
		...
		world.setBlock(i + 6, j + 9, k + 5, Blocks.slateBricks.blockID);
		...
		world.setBlock(i + 7, j + 1, k + 2, Blocks.slateBricks.blockID);
		...
		world.setBlock(i + 7, j + 2, k + 2, Block.fenceIron.blockID);
		...
		world.setBlock(i + 7, j + 3, k + 6, Blocks.slateBricks.blockID);
		world.setBlock(i + 7, j + 3, k + 7, Blocks.slateBricks.blockID);
		world.setBlock(i + 7, j + 4, k + 0, Blocks.slateBricks.blockID);
		...
		world.setBlock(i + 1, j + 4, k + 1, Blocks.lamp.blockID);
