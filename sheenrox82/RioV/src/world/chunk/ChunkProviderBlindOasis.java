...
public class ChunkProviderBlindOasis implements IChunkProvider
{
	 ...
	 public void generateNetherTerrain(int par1, int par2, byte[] par3ArrayOfByte)
	{
					...
					for (int l1 = 0; l1 < 8; ++l1)
					{
						...
						for (int i2 = 0; i2 < 4; ++i2)
						{
							...
							for (int k2 = 0; k2 < 4; ++k2)
							{
								...
								if (k1 * 8 + l1 < b1)
								{
									l2 = Blocks.voidStill.blockID;
								}

								if (d15 > 0.0D)
								{
									l2 = Blocks.blackRock.blockID;
								}
	 ...
	 public void replaceBlocksForBiome(int par1, int par2, byte[] par3ArrayOfByte)
	 {
		 ...
		 for (int k = 0; k < 16; ++k)
		 {
			 for (int l = 0; l < 16; ++l)
			 {
				 ...
				 int j1 = -1;
				 byte b1 = (byte)Blocks.blackRock.blockID;
				 byte b2 = (byte)Blocks.blackRock.blockID;
				 ...
				 for (int k1 = 127; k1 >= 0; --k1)
				 {
					 ...
					 if (k1 < 127 - this.rand.nextInt(5) && k1 > 0 + this.rand.nextInt(5))
					 {
						 ...
						 else if (b3 == Blocks.blackRock.blockID)
						 {
							 if (j1 == -1)
							 {
								 if (i1 <= 0)
								 {
									 b1 = 0;
									 b2 = (byte)Blocks.blackRock.blockID;
								 }
								 else if (k1 >= b0 - 4 && k1 <= b0 + 1)
								 {
									 b1 = (byte)Blocks.blackRock.blockID;
									 b2 = (byte)Blocks.blackRock.blockID;
								 ...
								 if (k1 < b0 && b1 == 0)
								 {
									 b1 = (byte)Blocks.voidStill.blockID;
								 }
	 ...
	 public Chunk provideChunk(int par1, int par2)
	 {
		 ...
		 {
			 abyte1[k] = (byte)Biomes.blindOasis.biomeID;
		 }
	 ...
	 public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
	 {
		 ...
		 for(int x =0; x < 8; x++)
		 {
			 ...
			 int Ycoord = rand.nextInt(98);
			 int Zcoord = j + rand.nextInt(16);
			 (new WorldGenBlindOasisMineable(Blocks.blindoniteOre.blockID, 3)).generate(worldObj, rand, Xcoord, Ycoord, Zcoord);
		 }
