...
public class ChunkProviderSanctuatite implements IChunkProvider
{
					...
					for (int var29 = 0; var29 < 4; ++var29)
					{
						...
						for (int var40 = 0; var40 < 8; ++var40)
						{
							...
							for (int var49 = 0; var49 < 8; ++var49)
							{
								...
								if (var45 > 0.0D)
								{
									var50 = Blocks.sanctuaryStone.blockID;
								}
	...
	public void func_28072_a(int var1, int var2, byte[] var3)
	{
		...
		for (int var6 = 0; var6 < 16; ++var6)
		{
			for (int var7 = 0; var7 < 16; ++var7)
			{
				...
				byte var12 = (byte)Blocks.sanctuaryStone.blockID;
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
	{
		...
		for(int x =0; x < 8; x++)
        {
            ...
            (new WorldGenSanctuatiteMineable(Blocks.alerisOre.blockID, 3)).generate(this.worldObj, this.rand, var14, var15, var16);
        }
		...
		if (biomegenbase == Biomes.sanctuatite)
		{
	...
	{
		BiomeGenBase var5 = Biomes.sanctuatite;
