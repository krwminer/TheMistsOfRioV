...
public class ChunkProviderAtlantea implements IChunkProvider
{
	private Random rand;
	...
	public ChunkProviderAtlantea(World par1World, long par2, boolean par4) {
						...
						for (int i2 = 0; i2 < 4; ++i2)
						{
							...
							for (int k2 = 0; k2 < 4; ++k2)
							{
								if ((d16 += d15) > 0.0D)
								{
									...
									par3ArrayOfByte[j2 += short1] = (byte)Block.sand.blockID;//
								}
								else if (k1 * 8 + l1 < b2)
								{
			...
			for (int var9 = 0; var9 < 16; var9++)
			{
				...
				for (int var16 = 127; var16 >= 0; var16--)
				{
					...
					else
					{
						...
						/** Main filler block fill's all the underground, replaces block stone **/
						else if (var18 != Block.sand.blockID)
						{
							if (var13 == -1)
							{
								if (var12 == 0)
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
	{
		...
		for(int var5 = 0; var5 < 2; ++var5)
		{
			...
			new WorldGenBalance(Blocks.coconut.blockID).generate(worldObj, rand, var6, var7, var8);
		}
