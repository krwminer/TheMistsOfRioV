...
public class TeleporterBlindOasis extends Teleporter
{
	...
	public TeleporterBlindOasis(WorldServer par1WorldServer)
	{
	...
	public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
	{
		...
		else
		{
			for (k1 = l - short1; k1 <= l + short1; ++k1)
			{
				...
				for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
				{
					...
					{
						/** change this block **/
						if (this.worldServerInstance.getBlockId(k1, i2, l1) == Blocks.blindOasisPortal.blockID)
						{
							/** change this block **/
							while (this.worldServerInstance.getBlockId(k1, i2 - 1, l1) == Blocks.blindOasisPortal.blockID)
							{
								--i2;
							}
		...
		if (d3 >= 0.0D)
		{
			...
			int j2 = -1;
			/** change this block **/
			if (this.worldServerInstance.getBlockId(i - 1, j, k) == Blocks.blindOasisPortal.blockID)
			{
				j2 = 2;
			}
			/** change this block **/
			...
			/** change this block **/
			if (this.worldServerInstance.getBlockId(i, j, k - 1) == Blocks.blindOasisPortal.blockID)
			{
				j2 = 3;
			}
			/** change this block **/
