...
public class WorldGenFlamonorMineable extends WorldGenerator
{
    ...
    public WorldGenFlamonorMineable(int par1, int par2)
    {
        this(par1, par2, Blocks.flamonorRock.blockID);
    }

    public WorldGenFlamonorMineable(int par1, int par2, int par3)
    {
    ...
    public WorldGenFlamonorMineable(int id, int meta, int number, int target)
    {
