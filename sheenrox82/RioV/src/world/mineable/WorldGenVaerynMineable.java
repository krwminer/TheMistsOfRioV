...
public class WorldGenVaerynMineable extends WorldGenerator
{
    ...
    public WorldGenVaerynMineable(int par1, int par2)
    {
        this(par1, par2, Blocks.glimmerRock.blockID);
    }

    public WorldGenVaerynMineable(int par1, int par2, int par3)
    {
    ...
    public WorldGenVaerynMineable(int id, int meta, int number, int target)
    {
