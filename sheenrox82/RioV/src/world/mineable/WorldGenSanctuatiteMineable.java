...
public class WorldGenSanctuatiteMineable extends WorldGenerator
{
    ...
    public WorldGenSanctuatiteMineable(int par1, int par2)
    {
        this(par1, par2, Blocks.sanctuaryStone.blockID);
    }

    public WorldGenSanctuatiteMineable(int par1, int par2, int par3)
    {
    ...
    public WorldGenSanctuatiteMineable(int id, int meta, int number, int target)
    {
