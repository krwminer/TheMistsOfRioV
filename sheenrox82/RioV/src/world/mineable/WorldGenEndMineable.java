...
public class WorldGenEndMineable extends WorldGenerator
{
    ...
    public WorldGenEndMineable(int par1, int par2)
    {
        this(par1, par2, Block.whiteStone.blockID);
    }

    public WorldGenEndMineable(int par1, int par2, int par3)
    {
    ...
    public WorldGenEndMineable(int id, int meta, int number, int target)
    {
