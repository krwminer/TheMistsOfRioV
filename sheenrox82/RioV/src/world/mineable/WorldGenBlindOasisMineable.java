...
public class WorldGenBlindOasisMineable extends WorldGenerator
{
    ...
    public WorldGenBlindOasisMineable(int par1, int par2)
    {
        this(par1, par2, Blocks.blackRock.blockID);
    }

    public WorldGenBlindOasisMineable(int par1, int par2, int par3)
    {
    ...
    public WorldGenBlindOasisMineable(int id, int meta, int number, int target)
    {
