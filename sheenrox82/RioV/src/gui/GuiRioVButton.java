...
public class GuiRioVButton extends GuiButton
{
    ...
    public GuiRioVButton(int par1, int par2, int par3, String par4Str)
    {
        this(par1, par2, par3, 200, 20, par4Str);
    }

    public GuiRioVButton(int par1, int par2, int par3, int par4, int par5, String par6Str)
    {
