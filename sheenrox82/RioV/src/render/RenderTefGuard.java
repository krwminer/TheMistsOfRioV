...
public class RenderTefGuard extends RenderBiped
{
	public RenderTefGuard()
	{
		super(new ModelBiped(), 0.5F);

	}

	public void renderAdv(EntityTefGuard var1, double var2, double var4, double var6, float var8, float var9)
	{
	...
	{
		renderAdv((EntityTefGuard)var1, var2, var4, var6, var8, var9);
	}
