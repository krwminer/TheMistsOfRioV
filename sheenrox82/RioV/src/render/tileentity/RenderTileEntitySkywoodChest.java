...
public class RenderTileEntitySkywoodChest extends TileEntityChestRenderer
{
	...
	public RenderTileEntitySkywoodChest()
	{
	...
	public void renderTileEntityAt(TileEntity var1, double x, double y,
			double z, float tick)
	{
		this.renderAModelAt((TileEntitySkywoodChest)var1, x, y, z, tick);
	}
