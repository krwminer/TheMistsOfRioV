...
public class RenderTileEntityCherryBlossomChest extends TileEntityChestRenderer
{
	...
	public RenderTileEntityCherryBlossomChest()
	{
	...
	public void renderTileEntityAt(TileEntity var1, double x, double y,
			double z, float tick)
	{
		this.renderAModelAt((TileEntityCherryBlossomChest)var1, x, y, z, tick);
	}

	public void renderAModelAt(TileEntityCherryBlossomChest tile, double x, double y, double z, float f)
	{
		int rotation = 0;
		...
		if (tile.adjacentChestZNeg == null && tile.adjacentChestXNeg == null)
		{
			...
			if (tile.adjacentChestXPos == null && tile.adjacentChestZPosition == null)
			{
				...
				this.bindTexture(TileEntityResourceLocation.cherryBlossom_singleChest);
			...
			else
			{
				...
				this.bindTexture(TileEntityResourceLocation.cherryBlossom_doubleChest);
