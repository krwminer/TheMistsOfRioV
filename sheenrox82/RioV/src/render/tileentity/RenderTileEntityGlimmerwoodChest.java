...
public class RenderTileEntityGlimmerwoodChest extends TileEntityChestRenderer
{
	...
	public void renderTileEntityAt(TileEntity var1, double x, double y,
			double z, float tick)
	{
		this.renderAModelAt((TileEntityGlimmerwoodChest)var1, x, y, z, tick);
	}

	public void renderAModelAt(TileEntityGlimmerwoodChest tile, double x, double y, double z, float f)
	{
		int rotation = 0;
