...
public class RenderAunTunBodyguard extends RenderBiped
{
	public RenderAunTunBodyguard()
	{
		super(new ModelBiped(), 0.5F);

	}

	public void renderAdv(EntityAunTunBodyguard var1, double var2, double var4, double var6, float var8, float var9)
	{
	...
	{
		renderAdv((EntityAunTunBodyguard)var1, var2, var4, var6, var8, var9);
	}
