...
public class RenderTasaravMallor extends RenderBiped
{
    public RenderTasaravMallor()
    {
        super(new ModelBiped(), 0.0F);
    }

	public void renderAdv(EntityTasaravMallor var1, double var2, double var4, double var6, float var8, float var9)
	{
	...
	{
		renderAdv((EntityTasaravMallor)var1, var2, var4, var6, var8, var9);
	}
	...
	{
		return EntityResourceLocation.adventurer;
	}
}
