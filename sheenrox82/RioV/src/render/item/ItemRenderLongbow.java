...
public class ItemRenderLongbow implements IItemRenderer
{
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data)
	{
		...
		if(renderFirstPerson || !renderFirstPerson)
		{
			float f22 = 0.375F;
	 ...
	 public void renderItem(EntityLivingBase par1EntityLiving, ItemStack par2ItemStack, int par3)
	{
		...
		GL11.glTranslatef(-f4, -0.6F, 0.0F);
		float f6 = 1.5F;
		GL11.glScalef(f6, 2.2F, f6);
		GL11.glRotatef(50.0F, 0.0F, 1.0F, 0.0F);
		GL11.glRotatef(335.0F, 0.0F, 0.0F, 1.0F);
		GL11.glTranslatef(-1F, -0.16F, 0.0F);
