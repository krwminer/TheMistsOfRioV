...
public class RenderGalokin extends RenderBiped
{
	
	public RenderGalokin()
	{
		super(new ModelBiped(), 0.5F);

	}

	public void renderAdv(EntityGalokin var1, double var2, double var4, double var6, float var8, float var9)
	{
	...
	{
		renderAdv((EntityGalokin)var1, var2, var4, var6, var8, var9);
	}
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		...
		return EntityResourceLocation.galokin;
	}
}
