...
public class EntityTef extends EntityBossCore
{
	...
	public EntityTef(World par1World)
	{
		...
		isImmuneToFire = true;
		this.setCurrentItemOrArmor(4, new ItemStack(Items.tefHelmet));
		this.setCurrentItemOrArmor(3, new ItemStack(Items.tefChestplate));
		this.setCurrentItemOrArmor(2, new ItemStack(Items.tefLeggings));
		this.setCurrentItemOrArmor(1, new ItemStack(Items.tefBoots));
	}
