...
public class EntityTefGuard extends EntityMobDeadBody
{
	...
	public EntityTefGuard(World par1World)
	{
		...
		this.setCurrentItemOrArmor(4, new ItemStack(Items.infusedOnyxHelmet));
		this.setCurrentItemOrArmor(3, new ItemStack(Items.infusedOnyxChestplate));
		this.setCurrentItemOrArmor(2, new ItemStack(Items.infusedOnyxLeggings));
		this.setCurrentItemOrArmor(1, new ItemStack(Items.infusedOnyxBoots));
	}
