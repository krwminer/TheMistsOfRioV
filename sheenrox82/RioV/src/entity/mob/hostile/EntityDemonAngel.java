...
public class EntityDemonAngel extends EntityMobDeadBody implements IBossDisplayData
{
	...
	public void onDeath(DamageSource par1DamageSource)
	{
		...
		if(this.worldObj.isRemote)
			Minecraft.getMinecraft().thePlayer.addChatMessage("\u00A74Demon Angel\u00A7f: Aarrrrrrgghhhhhhhh!");

		if(this.worldObj.isRemote)
			Minecraft.getMinecraft().thePlayer.addChatMessage("Demon Angel was killed!");
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setAttribute(38.0D);
	}
	...
	{
		this.dropItem(Items.vulron.itemID, 2);
	}

	@Override
	protected void dropRareDrop(int par1)
	{
		this.dropItem(Items.darkMatter.itemID, 1);
	}
