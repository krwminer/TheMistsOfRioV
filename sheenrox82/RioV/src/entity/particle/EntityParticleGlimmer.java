package sheenrox82.RioV.src.entity.particle;
...
public class EntityParticleGlimmer extends EntityFX
{
	...
	public EntityParticleGlimmer(World par1World, double par2, double par4, double par6, float par8, float par9, float par10)
	{
		this(par1World, par2, par4, par6, 1.0F, par8, par9, par10);
	}

	public EntityParticleGlimmer(World par1World, double par2, double par4, double par6, float par8, float par9, float par10, float par11)
	{
