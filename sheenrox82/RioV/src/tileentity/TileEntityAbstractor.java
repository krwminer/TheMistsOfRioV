...
import sheenrox82.RioV.src.recipe.AbstractorRecipes;
import cpw.mods.fml.common.registry.GameRegistry;

public class TileEntityAbstractor extends TileEntity implements IInventory
{
    ...
    public void updateEntity()
    {
        ...
        if (!worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockRuneAbstractor.updateFurnaceBlockState(this.dualBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        ItemStack itemstack = AbstractorRecipes.getSmeltingResult(blastItemStacks[0].getItem().itemID, blastItemStacks[1].getItem().itemID);
