...
public class TileEntityDarkener extends TileEntity implements IInventory
{
    /**
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack var1 = DarkenerRecipes.recipe().getResult(this.altarItemStacks[0]);
    ...
    public static int getItemBurnTime(ItemStack par0ItemStack)
    {
        ...
        else
        {
            ...
            if (var1 == Items.darkMatter.itemID)
            {
            	return 2;
            }
