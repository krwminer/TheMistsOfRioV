...
public class MagicBinderShapedRecipes implements IRecipe
{
	...
	public MagicBinderShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
	{
	...
	public MagicBinderShapedRecipes func_92100_c()
	{
