...
public class ItemTasaravHelmet extends ItemArmor
{
	public String armorNamePrefix;
	public EnumArmorMaterial material;
	public boolean isInfused;

	public ItemTasaravHelmet(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4, String armornamePrefix, boolean par5)
	{
	...
	{
		return Util.MOD_ID + ":" + "textures/armor/" + "TasaravHelmet.png";
	}
	...
	public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack, int armorSlot) 
	{
		...
		if(itemStack != null)
		{
			if(itemStack.getItem() instanceof ItemTasaravHelmet)
			{
				if(type == 0 || type == 1)
				{
	...
	{
		if ((itemID == Items.tasaravHelmet.itemID))
		{
			this.itemIcon = par1IconRegister.registerIcon(Util.MOD_ID + ":" + "tasaravHelmet");
		}
	}
