...
public class ItemBowOfWurTun extends ItemBow
{
	public EntityDarknessArrow arrow = new EntityDarknessArrow(null);
	public static final String[] bowPullIconNameArray = new String[] {Util.MOD_ID + ":" + "wBow_pull_0", Util.MOD_ID + ":" + "wBow_pull_1", Util.MOD_ID + ":" + "wBow_pull_2"};
	@SideOnly(Side.CLIENT)
	private Icon[] iconArray;

	public ItemBowOfWurTun(int par1)
	{
		super(par1 - 256);
		this.maxStackSize = 1;
	...
	public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
	{
		...
		if (flag || par3EntityPlayer.inventory.hasItem(Items.darknessArrow.itemID))
		{
			...
			{
				par3EntityPlayer.inventory.consumeInventoryItem(Items.darknessArrow.itemID);
			}
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
	{
		...
		if (par3EntityPlayer.capabilities.isCreativeMode || par3EntityPlayer.inventory.hasItem(Items.darknessArrow.itemID))
		{
	...
	{
		this.itemIcon = par1IconRegister.registerIcon(Util.MOD_ID + ":" + "bowOfWurTun");
