...
public class ItemDragonChestplate extends ItemArmor
{
	...
	public ItemDragonChestplate(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4, String armornamePrefix, boolean par5)
	{
	...
	public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack, int armorSlot) 
	{
		...
		if(itemStack != null)
		{
			if(itemStack.getItem() instanceof ItemDragonChestplate)
			{
				if(type == 1 || type == 3)
				{
					armorModel = TheMistsOfRioV.getInstance().commonProxy.getArmorModel(0);
				}
				else
				{
