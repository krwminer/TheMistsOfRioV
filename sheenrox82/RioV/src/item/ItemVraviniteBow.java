...
public class ItemVraviniteBow extends ItemBow
{
	public EntityVraviniteArrow arrow = new EntityVraviniteArrow(null);
	public static final String[] bowPullIconNameArray = new String[] {Util.MOD_ID + ":" + "vBow_pull_0", Util.MOD_ID + ":" + "vBow_pull_1", Util.MOD_ID + ":" + "vBow_pull_2"};
	@SideOnly(Side.CLIENT)
	private Icon[] iconArray;

	public ItemVraviniteBow(int par1)
	{
		super(par1 - 256);
		this.maxStackSize = 1;
	...
	public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
	{
		...
		if (flag || par3EntityPlayer.inventory.hasItem(Items.vraviniteArrow.itemID))
		{
			...
			{
				par3EntityPlayer.inventory.consumeInventoryItem(Items.vraviniteArrow.itemID);
			}
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
	{
		...
		if (par3EntityPlayer.capabilities.isCreativeMode || par3EntityPlayer.inventory.hasItem(Items.vraviniteArrow.itemID))
		{
	...
	{
		this.itemIcon = par1IconRegister.registerIcon("RioV:vraviniteBow");
	...
	public void addInformation(ItemStack var1, EntityPlayer var2, List var3, boolean var4)
	{
		if(Config.showToolInfo)
		{
			...
			{
				var3.add("Damage: " + arrow.damage * 1.4);
			}
			else
			{
				var3.add("Damage: " + arrow.damage);
			}
		}
	}
