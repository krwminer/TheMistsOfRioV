...
public class RioVDoor extends Item
{
	...
	public RioVDoor(int par1, Material par2Material)
	{
		super(par1 - 256);
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
	{
		...
		else
		{
			...
			if (itemID == Items.glimmerwoodDoorItem.itemID)
			{
				block = Blocks.glimmerwoodDoor;
			}
			if (itemID == Items.cherryBlossomDoorItem.itemID)
			{
				block = Blocks.cherryBlossomDoor;
			}
			if (itemID == Items.skywoodDoorItem.itemID)
			{
				block = Blocks.skywoodDoor;
			}
			if (itemID == Items.bloodDoorItem.itemID)
			{
				block = Blocks.bloodDoor;
			}
	...
	public void registerIcons(IconRegister par1IconRegister)
	{
		if(itemID == Items.cherryBlossomDoorItem.itemID)
		{
			this.itemIcon = par1IconRegister.registerIcon(Util.MOD_ID + ":" + "cherryBlossomDoorItem");
		}

		if(itemID == Items.glimmerwoodDoorItem.itemID)
		{
			this.itemIcon = par1IconRegister.registerIcon(Util.MOD_ID + ":" + "glimmerwoodDoorItem");
		}
		
		if(itemID == Items.skywoodDoorItem.itemID)
		{
			this.itemIcon = par1IconRegister.registerIcon(Util.MOD_ID + ":" + "skywoodDoorItem");
		}
		
		if(itemID == Items.bloodDoorItem.itemID)
		{
			this.itemIcon = par1IconRegister.registerIcon(Util.MOD_ID + ":" + "bloodDoorItem");
		}
	}
}
